                        ...
                        <div className="col-10 mx-auto col-md-6 my-3 p-5">
                            ...
                            <h4 className="text-blue">
                                <strong className="price">
                                    price : <span>$</span>{price},00
                                </strong>
                            </h4>
                            <p className="info py-3 my-3">
                                {info}
                            </p>
                            <h4 className="mt-3 mb-2">
                                <strong className="made">Made by : <span>
                                    {company}
                                </span>
                                </strong>
                            </h4> 
                            <div className="container-button">
                                ...
                                >
                                    {inCart?<FontAwesomeIcon cart icon={faCheck} style={{color: "#FFF"}} /> : <FontAwesomeIcon icon={faCartPlus} style={{color: "#FFF"}} />}
                                </ButtonContainer>
                            </div>               
                        </div>
